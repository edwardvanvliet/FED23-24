...
<details open>
  ...
  - Gebruik aria-label(s) voor screenreader, met name voor knoppen waarbij het voor de gebruiker onduidelijk is waarvoor de desbetreffende knop voor bedoeld is, waar ga je naartoe? (Feedforward!)
  - ...
